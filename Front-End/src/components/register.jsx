...
function Register({ isOpen, onRequestClose }) {
    ...
    return (
        <Modal isOpen={isOpen}
            ...
            className="register_custom-modal"
            ...
            <section className="bg-gray-50 pt-6 pb-6 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center w-full  px-6 py-8 mx-auto   lg:py-0">
                    ...
                    <div className="w-full  bg-white rounded-[2rem] shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">

...
function Cart() {
    ...
    const CartUserIds = async () => {
        axios.defaults.headers.common["Authorization"] = `${localStorage.getItem('Token')}`

        const response = await axios.get("http://localhost:4000/CartGetByUserId");
        const CartUserIdInfo = response.data.CartGetByUserIdInfo
        setCartUserId(CartUserIdInfo)
                    ...
                    <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                        <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                            <div className="space-y-6">
                                {
                                    CartUserId && CartUserId.map((Cart) => (
                                        <div className=" border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                            <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                                <a href="#" className="shrink-0 md:order-1">
                                                    ...
                                                    <img className="hidden h-20 w-20 dark:block" src={Cart.img_url} alt="imac image" />
                                                </a>

                                                <label for="counter-input" className="sr-only">{Cart.quantity}</label>
                                                <div className="flex items-center justify-between md:order-3 md:justify-end">
                                                    <div className="flex items-center">
                                                        ...
                                                        <input type="number" id="counter-input" data-input-counter className="w-10 shrink-0 border-0 bg-transparent text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0 dark:text-white" placeholder="" value={Cart.quantity} required />
                                                    ...
                                                    <div className="text-end md:order-4 md:w-32">
                                                        <p className="text-base font-bold text-gray-900 dark:text-white">${parseInt(Cart.price)}</p>
                                                    </div>
                                                </div>

                                                <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                    <a href="#" className="text-base font-medium text-gray-900 hover:underline dark:text-white">{Cart.description}</a>
